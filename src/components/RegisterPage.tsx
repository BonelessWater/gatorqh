      ...
      <div className="bg-[#001f3f] py-20">
        <div className="max-w-3xl mx-auto px-6 text-center">
          <h1 className="text-4xl md:text-5xl text-white mb-4">
            Register for <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-400">Quantathon 2026</span>
          </h1>
          ...
          <div className="bg-[#001f3f] p-8 rounded-lg border border-gray-800">
            ...
            <div className="space-y-2 mt-6">
              <Label htmlFor="motivation" className="text-white">
                Why do you want to participate in Quantathon 2026? *
              </Label>
              <Textarea
                id="motivation"
                required
